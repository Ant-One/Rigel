...
public class ObserverLocationBean {
    ...
    private ObjectProperty<Double> lonDeg ;
    private ObjectProperty<Double> latDeg;
     ...
     * @return the longitude property
     */
    public ObjectProperty<Double> lonDegProperty() {
        return lonDeg;
    }
     ...
     * @return the latitude property
     */
    public ObjectProperty<Double> latDegProperty() {
        return latDeg;
    }
